...
**It can also be run as root, but this will require to `chpst` everytime and you'll get better control and security isolating podman containers to an unprivileged user.**
